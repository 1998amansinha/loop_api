  ...
  const fetchTopCategories = async () => {
    try {
      ...
      if (data.documents) {
        ...
        setTopCategories(categories.slice(7, 18));
      }
    } catch (error) {
        ...
        >
          ...
          <div className="py-2 px-6 text-neutral">
            ...
            <div className="my-5 flex justify-end">
              <button className="bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-semibold shadow-md hover:bg-gray-900 transition cursor-pointer">
                Explore Now
              </button>
            </div>
          </div>
